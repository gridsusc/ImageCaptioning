...
padded_train_caps_json = list(map(lambda a: padEachCaption(a, baseCaptionLen), train_caps_json))
padded_test_caps_json = list(map(lambda a: padEachCaption(a, baseCaptionLen), test_caps_json))
padded_val_caps_json = list(map(lambda a: padEachCaption(a, baseCaptionLen), val_caps_json))
length_train_caps_json = list(map(lambda a:min(len(a)+2,baseCaptionLen),train_caps_json))
length_test_caps_json = list(map(lambda a:min(len(a)+2,baseCaptionLen),test_caps_json))
length_val_caps_json = list(map(lambda a:min(len(a)+2,baseCaptionLen),val_caps_json))
